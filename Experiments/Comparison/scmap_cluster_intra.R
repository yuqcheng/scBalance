...
setwd("C:/Users/Plus0/Desktop/data1/AMB")
raw_data <- read.csv("Filtered_mouse_allen_brain_data.csv", header = T, row.names = 1)
...
for (i in 1:(n_folds-1)){
  ...
  ref_sce <- indexCluster(ref_sce,"X")
  ...
  test_sce <- indexCluster(test_sce,"X")
