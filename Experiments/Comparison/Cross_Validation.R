Cross_Validation <- function(LabelsPath, col_Index = 1,OutputDir){
  ...
  setwd(OutputDir)
  save(n_folds,Train_Idx,Test_Idx,col_Index,Cells_to_Keep,file = 'CV_folds_filter10.RData')
}
LabelsPath='E:/dataset/Single cell classification datasets/Intra-dataset/Zheng 68K/Labels.csv'
OutputDir='E:/dataset/Single cell classification datasets/Intra-dataset/Zheng 68K/'
Cross_Validation(LabelsPath=LabelsPath,col_Index=1,OutputDir=OutputDir)