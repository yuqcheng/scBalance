...
TruePath='E:/dataset/Single cell classification datasets/Intra-dataset/Zheng 68K/scVI_True_Labels.csv'
PredPath='E:/dataset/Single cell classification datasets/Intra-dataset/Zheng 68K/scVI_Pred_Labels.csv'
result=evaluate(TrueLabelsPath = TruePath,PredLabelsPath = PredPath)